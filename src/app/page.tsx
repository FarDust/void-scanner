...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <header className={`sticky top-0 z-50 bg-blue-900 dark:bg-blue-950 text-white py-4 md:py-6 transition-shadow ${isScrolled ? 'shadow-lg' : ''}`}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:justify-between md:items-center">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                {/* App logo */}
                <div className="bg-blue-700 dark:bg-blue-800 rounded-lg p-2 mr-2">
                  <svg 
                ...
                <div>
                  <h1 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-300">Void Scanner</h1>
                  <p className="text-blue-200 text-sm mt-1">Detecting anomalies in the cosmic void</p>
                </div>
              </div>
              ...
              <div className="flex md:hidden items-center space-x-2">
                ...
                <button 
                  ...
                  className="relative inline-flex items-center justify-center p-2 rounded-lg transition-colors bg-blue-800 hover:bg-blue-700"
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button 
                onClick={() => setShowDemoControls(!showDemoControls)}
                className="flex items-center space-x-1 bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition-colors shadow-md text-sm"
              >
                <span>
                  {showDemoControls ? 'Hide Demo Mode' : 'Demo Mode'}
                </span>
                <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  className="h-4 w-4" 
          ...
          {/* Navigation Tabs */}
          <div className="mt-6 border-b border-blue-800 overflow-x-auto scrollbar-hide">
            <nav className="-mb-px flex space-x-2 md:space-x-8">
              <button
                onClick={() => setActiveTab('tinder')}
                className={`pb-3 px-3 whitespace-nowrap transition-colors ${
                  activeTab === 'tinder'
      ...
      <main className="container mx-auto px-4 py-6 md:px-6 md:py-8 lg:py-12">
            ...
            <section className="space-y-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700 transition-all duration-300 hover:shadow-lg">
                ...
                <div className="flex items-center mb-4">
                  <div className="h-4 w-4 rounded-full bg-green-500 mr-2 animate-pulse"></div>
                  <span className="text-gray-800 dark:text-gray-200">API Status: <span className="font-medium">Online</span></span>
                </div>
                ...
                <div className="mt-6 flex flex-wrap gap-4">
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 flex-1 min-w-[200px]">
                    <h3 className="text-sm font-medium text-blue-700 dark:text-blue-300 mb-1">System Uptime</h3>
                    <p className="text-2xl font-bold text-blue-800 dark:text-blue-200">99.97%</p>
                  ...
                  <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4 flex-1 min-w-[200px]">
                    <h3 className="text-sm font-medium text-green-700 dark:text-green-300 mb-1">Response Time</h3>
                    <p className="text-2xl font-bold text-green-800 dark:text-green-200">184ms</p>
                    <p className="text-xs text-green-600 dark:text-green-400 mt-1">Average</p>
                  </div>
                </div>
              </div>
            </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left mb-6 md:mb-0">
              <div className="flex items-center justify-center md:justify-start mb-3">
                <div className="bg-blue-700 dark:bg-blue-800 rounded-lg p-1 mr-2">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="text-gray-400 text-sm max-w-md mx-auto md:mx-0">
                A crowdsourced anomaly detection platform for astronomical data, helping researchers identify cosmic anomalies
              </p>
            </div>
            <div className="flex flex-col items-center md:items-end">
              <p className="text-sm text-gray-400 mb-2">© 2025 Void Scanner Project</p>
